...
time = timeit.timeit(stmt='reshape(height, width)', setup="from __main__ import reshape, width, height", number=1000)
print(1000.0/time)
time = timeit.timeit(stmt='reshapeAndDisplayImage(height, width)', setup="from __main__ import reshapeAndDisplayImage, ctx, width, height", number=1000)
print(1000.0/time)
